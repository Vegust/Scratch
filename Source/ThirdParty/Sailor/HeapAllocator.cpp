...
{
	return min(2048ull, max((size_t)(m_totalSize * 0.05f), SAILOR_SMALLEST_DATA_SIZE * 2ull));
}
...
void* PoolAllocator::Allocate(size_t size, size_t alignment)
{
	...
	const size_t newPageSize = max(neededPlace, min(maxBlockSize, quadraticGrow * m_pageSize));
